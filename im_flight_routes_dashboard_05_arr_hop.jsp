...
<div id="loading" name="loading/" style="background-color: #f5f9ff; ">
	...
	////////////////////////////////////////////////////// 	  Arrival Departure Main Table 		//////////////////////////////////////////////////////
				...
				while(rs1.next())
				{
					...
					flightNumber1 = rs1.getString("FLIGHT_NO");
					sourcePort1 = rs1.getString("SRC_PORT_CODE");
					destinationPort1 = rs1.getString("DEST_PORT_CODE");
					sourceCountryCode1 = rs1.getString("SRC_COUNTRY_CODE");
					hopPort1 = rs1.getString("HOP1_PORT_CODE")== null ? "": rs1.getString("HOP1_PORT_CODE");
					hopPort2 = rs1.getString("HOP2_PORT_CODE")== null ? "":rs1.getString("HOP1_PORT_CODE");
					destinationCountryCode1 = rs1.getString("DEST_COUNTRY_CODE");
					//out.println("While 1");
					sourcePortDesc1 = rs1.getString("SRC_PORT_DESC");
					sourceCountryDesc1 = rs1.getString("SRC_COUNTRY_DESC");
					destPortDesc1 = rs1.getString("DEST_PORT_DESC");
					destCountryDesc1 = rs1.getString("DEST_COUNTRY_DESC");
					hopPort1Desc = rs1.getString("HOP1_PORT_DESC");
					hopPort2Desc = rs1.getString("HOP2_PORT_DESC");
	...
	/*Note*/						selectRevQuery = "SELECT * FROM IM_FLIGHT_ROUTES WHERE FLIGHT_NO = '" + dep_flt_no + "' and SRC_COUNTRY_CODE ='IND'";
						...
						ps2 = con.prepareStatement(selectRevQuery);
						ResultSet rs2 = null;
						...
						if(rs2.next())  
						{
							...
							flightNumber2 = rs2.getString("FLIGHT_NO") == null ? "" : rs2.getString("FLIGHT_NO");
							destinationPort2 = rs2.getString("DEST_PORT_CODE") == null ? "" : rs2.getString("DEST_PORT_CODE");
							sourcePort2 = rs2.getString("SRC_PORT_CODE")== null ? "" : rs2.getString("SRC_PORT_CODE");
							sourceCountryCode2 = rs2.getString("SRC_COUNTRY_CODE")== null ? "" : rs2.getString("SRC_COUNTRY_CODE");
							hopPortDep1 = rs2.getString("HOP1_PORT_CODE")== null ? "":rs2.getString("HOP1_PORT_CODE");
							hopPortDep2 = rs2.getString("HOP2_PORT_CODE")== null ? "":rs2.getString("HOP2_PORT_CODE");
							destinationCountryCode2 = rs2.getString("DEST_COUNTRY_CODE")== null ? "" : rs2.getString("DEST_COUNTRY_CODE");
							//out.println("While 2");
							sourcePortDesc2 = rs2.getString("SRC_PORT_DESC");
							sourceCountryDesc2 = rs2.getString("SRC_COUNTRY_DESC");
							destPortDesc2 = rs2.getString("DEST_PORT_DESC");
							destCountryDesc2 = rs2.getString("DEST_COUNTRY_DESC");
							hopPort1_Desc = rs1.getString("HOP1_PORT_DESC");
							hopPort2_Desc = rs1.getString("HOP2_PORT_DESC");
