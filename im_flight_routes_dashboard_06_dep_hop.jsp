		...
		///////////////////////////////////////////////// 	  Arrival Hopping Table - Start		//////////////////////////////////////////////////////
				...
				while(rs1.next())
				{
					...
					%>	<tr>
						...
						<td align= "center" bgcolor="#fa4d56"><%=sourcePort1%> (<%=sourceCountryCode1%>)</td>
						<td align="center" bgcolor="#ff8389"><%=hopPort1%></td>
						<td align="center" bgcolor="#ffb3b8"><%=hopPort2%></td>
						<td align= "center" bgcolor="#ffd7d9"><%=destinationPort1%> (<%=destinationCountryCode1%>)</td>								
							...
							if(rs2.next())  
								{
									...
									%>													
										...
										<td align= "center" bgcolor="#009d9a"><%=sourcePort2%>(<%=sourceCountryCode2%>)</td>
										<td align="center" bgcolor="#08bdba"><%=hopPort1%></td>
										<td align="center" bgcolor="#3ddbd9"><%=hopPort2%></td>
										<td align= "center" bgcolor="#9ef0f0"><%=destinationPort2%>(<%=destinationCountryCode2%>)</td>
									</tr>
									<%
